 ...
 * orderId全局变量
 */
public class LoadMoreGridViewPullToreshView2 extends LinearLayout {
	...
	public LoadMoreGridViewPullToreshView2(Context context) {
		super(context);
		mContext = context;
	}
	...
	public void initWidget(Context mcontext) {
		...
		View layout = inflater.inflate(R.layout.grid_loadmore_pulltorefresh2,
				null);
		// 添加布局参数
		this.addView(layout, new LayoutParams(LayoutParams.FILL_PARENT,
				LayoutParams.FILL_PARENT));
		pullToRefreshView = (PullToRefreshView) findViewById(R.id.main_pull_refresh_view2);
		gridView = (GridView) findViewById(R.id.gvIndexData2);
		//设置监听器   将点击事件 写在adapter里
