 ...
 * 
  */
public class TotiPotentGridView2  extends LinearLayout implements 
			ICallBackAsyncTaskLister,OnHeaderRefreshListener,OnFooterRefreshListener {
	Context mContext=null;
	//更改
	LoadMoreGridViewPullToreshView2 loadMoreGridViewPullToreshView2=null;
	...
	public TotiPotentGridView2(Context context) {
		super(context);
		mContext=context;
	}
	
public TotiPotentGridView2(Context context,AttributeSet attributeSet) {
  ...
  */
  public void initWidget(Context context){
		...
		View layout = inflater.inflate(R.layout.loadatagridview_layout2, null);
		this.addView(layout);
		loadMoreGridViewPullToreshView2=(LoadMoreGridViewPullToreshView2) findViewById(R.id.lmgriviewpullview2);
		pullToRefreshView=loadMoreGridViewPullToreshView2.getPullToRefreshView();
		pullToRefreshView.setOnHeaderRefreshListener(this);
		pullToRefreshView.setOnFooterRefreshListener(this);
		gridView=loadMoreGridViewPullToreshView2.getGridView();
