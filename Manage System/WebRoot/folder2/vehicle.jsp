						...
						<p>
							<div align="center">
							   ...
							   <%
							    ...
							    %>
							    <a href="vehicle.jsp?pagenum=<%=1 %>">首页&nbsp;&nbsp;&nbsp;</a>
							     <%
							      }
							     %>  
								...
								%>
								<a
									href="vehicle.jsp?pagenum=<%=pagenum - 1%>&firstname=<%=firstname%>&lastname=<%=lastname%>"><img src="../picture/111.gif"/></a>
								<%
									}
								%>
								...
								%>
								<a
									href="vehicle.jsp?pagenum=<%=i%>&firstname=<%=firstname%>&lastname=<%=lastname%>">&nbsp;<%=i%>&nbsp;</a>
								<%
									}
								%>
								...
								%>
								<a
									href="vehicle.jsp?pagenum=<%=pagenum + 1%>&firstname=<%=firstname%>&lastname=<%=lastname%>"><img src="../picture/222.gif"/></a>
								<%
									}
								%>
							    ...
							    %>
							    <a href="vehicle.jsp?pagenum=<%=pb.getTotalpage() %>">&nbsp;&nbsp;&nbsp;尾页</a>
							     <%
							      }
							     %>  
